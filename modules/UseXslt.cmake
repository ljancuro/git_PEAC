...
function ( XSL_TRANSFORM xslurl infile )
  ...
  if ( XSLT_PARAMS_STR )
    foreach ( param ${XSLT_PARAMS_STR} )
      set ( param_name )
      string ( REGEX MATCH "[^=]+" param_name "${param}" )
      if ( param_name )
	set ( param_value )
	string ( REGEX REPLACE "[^=]+=(.*)" "\\1" param_value "${param}" )
	set ( XSLT_XSLTPROC_OPTIONS ${XSLT_XSLTPROC_OPTIONS} -stringparam ${param_name} ${param_value} )
	set ( XSLT_XALAN2_OPTIONS ${XSLT_XALAN2_OPTIONS} -stringparam ${param_name} ${param_value} )
      endif ( param_name )
    endforeach ( param )
  endif ( XSLT_PARAMS_STR )

  message(STATUS "opts are ${XSLT_XSLTPROC_OPTIONS}")
